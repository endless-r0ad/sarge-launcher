<script setup lang="ts">
  ...
  function getServerProtocol(serv: Quake3Server){
    if (serv.protocol) { return serv.protocol }
...
<template>  
  <div style="overflow: hidden;">
    <div class="server-row">
      ...
      <!-- <span v-if="server.master.game != 'Bloodrun'" style="width: 11%; text-align: left; white-space: nowrap;">{{ server.game }}</span> -->
      <!-- <span v-if="server.master.game == 'Bloodrun'" style="width: 11%; text-align: left; white-space: nowrap;">{{ server.master.game }}</span> -->
